  ...
  translation: {
    ...
    bot: {
      label: {
        ...
        syncStatus: {
          queue: 'Sincronizacao executando',
          running: 'Sincronizando',
          success: 'Sincronizacao Completada',
          fail: 'Sincronizacao com erro',
        },
        fileUploadStatus: {
          uploading: 'Subiendo...',
          uploaded: 'Subido',
...
¿Cómo clasificarías este correo electrónico?`,
    ...
    button: {
      newChat: 'ChatGPT',
      botConsole: 'Gerenciar Robos',
      sharedBotAnalytics: 'Análisis de Bots Compartidos',
      apiManagement: 'Gerenciar API',
      userUsages: 'Usos de Usuario',
      SaveAndSubmit: 'Salvar',
      resend: 'Reenviar',
    ...
    error: {
      answerResponse: 'Encontrei um erro.... tente novamente',
      notFoundConversation: 'Dado que el chat especificado no existe, se muestra una nueva pantalla de chat.',
      notFoundPage: 'Pagina de busca nao encontrada.',
      predict: {
        general: 'Encontrei um erro ....',
        invalidResponse: 'Encontrei um erro inesperado. O foamato da resposta nao confere.',
      },
      notSupportedImage: 'O modelo selecionado nao aceita imagens.',
    },
    validation: {
      title: 'Erro de Validacao',
      maxRange: {
        message: 'O valor maximo que se pode usar eh {{size}}',
      },
