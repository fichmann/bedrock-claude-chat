const translation = {
  translation: {
    ...
    app: {
      ...
      inputMessage: 'Enviar uma mensagem',
    ...
    bot: {
      label: {
        myBots: 'Meus Bots',
        recentlyUsedBots: 'Bots compartilhados usados recentemente',
        knowledge: 'Base de dados',
        url: 'URL',
        ...
        notAvailableBotInputMessage: 'Este bot NAO está disponivel.',
        noDescription: 'Sem Descricao',
        notAvailable: 'Este bot NAO está disponivel.',
        noBots: 'Nao existem Bots.',
        noBotsRecentlyUsed: 'Nao existem bots compartilhados usados recentemente.',
        retrievingKnowledge: '[Recuperando base de dados...]',
